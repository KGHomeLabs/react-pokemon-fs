...
export const usePokemonSpeciesList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['pokemonSpeciesList', limit, offset], 
    queryFn: () => {
      const pokemonService = PokemonServiceResolver.get();
      return pokemonService.getPokemonSpeciesList(limit, offset);
    }
  });
...
export const useAbilityList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['abilityList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getAbilityList(limit, offset);
  }});

export const useAbilityByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['ability', idOrName], queryFn: () => 
    {
      const pokemonService = PokemonServiceResolver.get();
      return pokemonService.getAbilityByIdOrName(idOrName);
    }
  });

export const useTypeList = () =>
  useQuery({ queryKey: ['typeList'], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getTypeList();
  }});

export const useTypeByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['type', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getTypeByIdOrName(idOrName);
  }});

export const useMoveList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['moveList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getMoveList(limit, offset);
  }});

export const useMoveByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['move', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getMoveByIdOrName(idOrName);
  }});

export const useMoveCategoryByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['moveCategory', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getMoveCategoryByIdOrName(idOrName);
  }});

export const useMoveDamageClassByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['moveDamageClass', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getMoveDamageClassByIdOrName(idOrName);
  }});

export const useItemList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['itemList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getItemList(limit, offset);
  }});

export const useItemByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['item', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getItemByIdOrName(idOrName);
  }});

export const useItemCategoryByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['itemCategory', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getItemCategoryByIdOrName(idOrName);
  }});

export const useItemPocketByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['itemPocket', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getItemPocketByIdOrName(idOrName);
  }});

export const useLocationList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['locationList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getLocationList(limit, offset);
  }});

export const useLocationByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['location', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getLocationByIdOrName(idOrName);
  }});

export const useLocationAreaByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['locationArea', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getLocationAreaByIdOrName(idOrName);
  }});

export const useRegionList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['regionList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getRegionList(limit, offset);
  }});

export const useRegionByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['region', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getRegionByIdOrName(idOrName);
  }});

export const useGenerationList = (limit = 20, offset = 0) =>
  useQuery({ queryKey: ['generationList', limit, offset], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getGenerationList(limit, offset);
  }});

export const useGenerationByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['generation', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getGenerationByIdOrName(idOrName);
  }});
...
export const useGenderByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['gender', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getGenderByIdOrName(idOrName);
  }});

export const useGrowthRateByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['growthRate', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getGrowthRateByIdOrName(idOrName);
  }});

export const useNatureByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['nature', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getNatureByIdOrName(idOrName);
  }});

export const useStatByIdOrName = (idOrName: string | number) =>
  useQuery({ queryKey: ['stat', idOrName], queryFn: () => {
    const pokemonService = PokemonServiceResolver.get();
    return pokemonService.getStatByIdOrName(idOrName);
  }});
